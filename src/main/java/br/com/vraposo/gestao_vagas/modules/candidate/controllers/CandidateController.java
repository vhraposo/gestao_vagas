package br.com.vraposo.gestao_vagas.modules.candidate.controllers;
...
import br.com.vraposo.gestao_vagas.modules.candidate.CandidateEntity;
import br.com.vraposo.gestao_vagas.modules.candidate.dto.ProfileCandidateResponseDTO;
import br.com.vraposo.gestao_vagas.modules.candidate.useCases.CreateCandidateUseCase;
...
public class CandidateController {
    ...
    @PostMapping("/")
    @Operation(summary = "Cadastro de candidato", description= "Essa função é responsável por cadastrar um cantidato.")
     @ApiResponses({
