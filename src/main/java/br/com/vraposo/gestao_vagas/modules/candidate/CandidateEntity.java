package br.com.vraposo.gestao_vagas.modules.candidate;
...
public class CandidateEntity {
    ...
    @Schema(example = "joao.silva", requiredMode = RequiredMode.REQUIRED, description = "Username do candidato")
    private String username;

    @Email(message = "O campo [email] deve ser um email válido")
    @Schema(example = "joao.silva@email.com", requiredMode = RequiredMode.REQUIRED, description = "E-mail do candidato")
